 ...
 public class DemoDataConfiguration
 {
   ...
   protected void initDemoGroups() {
     ...
     String[] arrayOfString1 = assignmentGroups;int i = arrayOfString1.length; for (String str1 = 0; str1 < i; str1++) { groupId = arrayOfString1[str1];
       createGroup(groupId, "assignment");
     }
     
     String[] securityGroups = { "user", "admin" };
     String[] arrayOfString2 = securityGroups;str1 = arrayOfString2.length; for (String groupId = 0; groupId < str1; groupId++) { String groupId = arrayOfString2[groupId];
       ...
       public void run()
       {
         ...
         while (!tasks.isEmpty()) {
           for (Task task : tasks)
           {
             ...
             DemoDataConfiguration.this.processEngineConfiguration.getClock().setCurrentTime(new Date(task
