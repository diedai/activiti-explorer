 ...
 public class SuspendedProcessDefinitionListQuery
   extends AbstractLazyLoadingQuery
 {
   ...
   {
     List<ProcessDefinition> processDefinitions = ((ProcessDefinitionQuery)((ProcessDefinitionQuery)this.repositoryService.createProcessDefinitionQuery().suspended().orderByProcessDefinitionName().asc()).orderByProcessDefinitionVersion().asc()).listPage(start, count);
